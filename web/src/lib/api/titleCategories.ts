// Shared title categories data - used by both TitleCategoriesModal and TitleSelectionModal
...
// Default categories with pre-defined titles
...
export const loadCategories = (): Categories => {
    try {
        ...
        if (stored) {
            ...
            // Merge with defaults (stored takes precedence for modifications)
...
// Save categories (only saves non-default categories)
export const saveCategories = (categories: Categories): void => {
