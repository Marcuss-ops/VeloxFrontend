    ...
    return (
        <div className="space-y-6 py-2">
            <div className="flex items-center justify-between flex-wrap gap-3">
                <h2 className="text-foreground text-2xl font-bold tracking-tight">Esecuzione in Corso</h2>
            ...
            {jobs.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-center border-2 border-dashed border-[#1f1f1f] rounded-xl bg-card/50">
                    <div className="size-16 rounded-full bg-card flex items-center justify-center mb-4 text-[#333]">
                        <PauseCircle className="size-8 " />
                    </div>
                    <h3 className="text-foreground font-bold text-lg mb-1">Nessun job in esecuzione</h3>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            <h4 className="text-foreground font-bold text-sm truncate max-w-[160px]" title={vid}>{vid}</h4>
                                    ...
                                    <div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-card border border-[#333] text-[10px] font-medium text-muted-foreground shrink-0 ml-2">
                                ...
                                <div className="grid grid-cols-2 gap-3 mb-4">
                                    ...
                                    <div className="bg-card/50 rounded-lg p-2 border border">
                                        <div className="text-[10px] uppercase tracking-wider text-muted-foreground font-bold mb-1">Stato</div>
                                ...
                                <div className="flex items-center justify-end gap-3">
                                    ...
                                    <a href={`/jobs/detail/${encodeURIComponent(jid)}`}
                                        className="text-xs font-semibold text-foreground hover:text-violet-400 transition-colors flex items-center gap-1">
