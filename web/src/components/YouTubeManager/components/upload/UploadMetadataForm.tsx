 ...
 * Pure presentational component for video upload metadata form
 */
...
import type { ChannelOption, ChannelGroupOption } from '../../hooks/useYouTubeChannelSelection';
...
export const UploadMetadataForm: React.FC<UploadMetadataFormProps> = ({
  ...
  return (
    <div className={`bg-surface dark:bg-surface-dark rounded-xl border border-border dark:border-border-dark p-4 space-y-4 transition-all ${!isSelected ? 'opacity-60' : ''}`}>
      {/* Upload compliance */}
