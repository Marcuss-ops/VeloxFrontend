...
export const GroupVideosEmptyState: React.FC<GroupVideosEmptyStateProps> = ({
    ...
    return (
        <div
            role="status"
            className={cn(
                'mx-auto flex max-w-2xl flex-col items-center gap-4 rounded-2xl border border-white/10 bg-slate-900/60 p-10 text-center',
            )}
        >
            <div className="rounded-full bg-white/5 px-3 py-1 text-xs uppercase tracking-widest text-slate-400">
