        ...
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Generazione voiceover multilingua</p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border bg-white/[0.02] px-6 py-16 text-center">
                ...
                <h2 className="mt-4 text-lg font-medium text-foreground/70">Voiceover Workspace</h2>
