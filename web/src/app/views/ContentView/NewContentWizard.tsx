    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-white/10 bg-white/[0.02] px-6 py-16 text-center">
                <span className="material-symbols-rounded text-5xl text-slate-600">construction</span>
                <h2 className="mt-4 text-lg font-medium text-slate-300">Wizard in costruzione</h2>
