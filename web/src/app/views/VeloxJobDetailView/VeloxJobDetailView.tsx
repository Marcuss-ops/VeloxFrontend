    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark">
      ...
      <main className="max-w-[1440px] mx-auto p-4 md:p-8 flex flex-col gap-6">
        ...
        <div className="flex items-center flex-wrap gap-2 text-sm font-medium">
          <button onClick={() => navigate('/analytics')} className="text-muted-foreground dark:text-muted-foreground hover:text-primary transition-colors flex items-center gap-1">
            <Home className="size-[18px]" />
            Dashboard
          </button>
          <ChevronRight className="size-4 " />
          <span className="text-foreground dark:text-slate-100 truncate max-w-xs" title={job.id}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-card/50 border border dark:border rounded-xl p-5 shadow-sm">
            <div className="text-muted-foreground dark:text-muted-foreground text-xs font-semibold uppercase tracking-wider mb-1">Stato Rendering</div>
          ...
          <div className="bg-white dark:bg-card/50 border border dark:border rounded-xl p-5 shadow-sm">
            <div className="text-muted-foreground dark:text-muted-foreground text-xs font-semibold uppercase tracking-wider mb-1">Creato</div>
            <div className="text-sm font-medium text-foreground/80">{formatDate(job.createdAt)}</div>
          </div>
          <div className="bg-white dark:bg-card/50 border border dark:border rounded-xl p-5 shadow-sm">
            <div className="text-muted-foreground dark:text-muted-foreground text-xs font-semibold uppercase tracking-wider mb-1">Ultimo aggiornamento</div>
