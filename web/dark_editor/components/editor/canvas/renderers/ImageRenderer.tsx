 ...
 * The shadow fields are applied on the inner image node exactly as before
 * (the drop-shadow offset object stays on the wrapping Group via
 * `restShadowProps`), preserving the previous Konva shadow behavior.
 */
