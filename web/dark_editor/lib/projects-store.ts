...
import { defaultFileSystem } from './fs';
import type { FileSystemPort } from './fs';
...
}, fileSystem: FileSystemPort = defaultFileSystem): StoredProject {
  const projects = ensureDataFile(fileSystem);
...
export function updateProject(id: string, updates: Partial<StoredProject>, fileSystem: FileSystemPort = defaultFileSystem): StoredProject | null {
  const projects = ensureDataFile(fileSystem);
...
export function assignProjectToFolder(projectId: string, folderId: string | null, fileSystem: FileSystemPort = defaultFileSystem): StoredProject | null {
